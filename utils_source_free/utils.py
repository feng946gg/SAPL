...
def validation_non_premap(net, config, test_loader, epoch, disable_log, device, list_ignore_classes=[],mapping_information=None):
    # 将网络设置为评估模式
    net.eval()
