    ...
    for name, parameter in model.named_parameters():
        if not config["parameter"]["finetune"]: 
            ...
            if config["parameter"]["fintune_setting"] == "complete_finetune":
                ...
                if (name == "net.ae_0_learned" or name == "net.be_0_learned" or name == "net.ae_1_learned" or name == "net.be_1_learned"
                        or name == "net.parametrizations.ae_0_learned.original" or name == "net.parametrizations.ae_1_learned.original"
                        or "ae_learned" in name or "be_learned" in name):
                    parameter.requires_grad=True
                    list_parameter_to_update.append(parameter)
